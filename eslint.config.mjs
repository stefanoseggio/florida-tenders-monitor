...
export default [
    ...
    // the README's runnable Node.js/Python examples, not part of src/'s
    // build - type-aware linting via parserOptions.project can't parse a
    // file outside the TS project, so it's excluded here rather than forced
    // into the main build's project scope.
